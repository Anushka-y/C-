...
int main()
{
    ...
    for (const auto& filename : filenames)
    {
        ...
        //count is the threshold that will define if image is blank or non-blank
        //total is the number of times window is created on the image
        ...
        // if image count (thershold) is less than 20, then blank image
        if (count < 20)
        {
